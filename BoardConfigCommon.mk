...
#somehow doesn't boot with console=ttyHSL0,115200,n8
BOARD_KERNEL_CMDLINE := androidboot.hardware=g2 androidboot.bootdevice=msm_sdcc.1 user_debug=31 msm_rtb.filter=0x0 mdss_mdp.panel=1:dsi:0:qcom,mdss_dsi_g2_lgd_cmd selinux=0
